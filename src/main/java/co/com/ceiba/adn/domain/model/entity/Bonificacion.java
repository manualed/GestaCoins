...
public class Bonificacion {
	...
	public Bonificacion(long idBonificacion, String codigoBonificacion, String nombreBonificacion, long valorBonificacion,
		...
		Validador.validarRangoNoValido(valorBonificacion, VALOR_NO_VALIDO_VALOR_BONIFICACION,VALOR_BONIFICACION_OBLIGATORIO);
		Validador.validarRangoValido(tipoBonificacion, MINIMO_TIPO_BONIFICACION, MAXIMO_TIPO_BONIFICACION, String.format(TIPO_BONIFICACION_ENTRE, MINIMO_TIPO_BONIFICACION,MAXIMO_TIPO_BONIFICACION));
		Validador.validarMaxLenght(codigoBonificacion, TAMANO_MAXIMO_CODIGO, String.format(CODIGO_BONIFICACION_DEBE_TENER_MAXIMO, TAMANO_MAXIMO_CODIGO));
		Validador.validarMinLenght(codigoBonificacion, TAMANO_MINIMO_CODIGO, String.format(CODIGO_BONIFICACION_DEBE_TENER_MINIMO, TAMANO_MINIMO_CODIGO));
		Validador.validarMaxLenght(nombreBonificacion, TAMANO_MAXIMO_NOMBRE, String.format(NOMBRE_BONIFICACION_DEBE_TENER_MAXIMO, TAMANO_MAXIMO_NOMBRE));
		Validador.validarMinLenght(nombreBonificacion, TAMANO_MINIMO_NOMBRE, String.format(NOMBRE_BONIFICACION_DEBE_TENER_MINIMO, TAMANO_MINIMO_NOMBRE));
